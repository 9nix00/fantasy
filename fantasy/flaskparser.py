# -*- coding: utf-8 -*-
"""
Flask request argument parsing module(Improved version).
Original version is :class:webargs.flaskparser.FlaskParser
...
def api_abort(error):
    abort(400, errors=error.messages, exc=error)
